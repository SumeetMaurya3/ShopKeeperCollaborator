...
gsap.to("#textonwis", {
    ...
    scrollTrigger: {
        ...
        scrub: 5,
        onEnter: function() { gsap.set("#textonwis", { opacity: 1 }) },
        onLeave: function() { gsap.set("#textonwis", { opacity: 0 }) },
    }
})
...
e.preventDefault();
wholepage = document.querySelectorAll(".gayab");
wholepage.classList.add("gayabhoja");
console.log("hurray");
// wholepage.remove();
window.open("/path");
if (!fullscreen) {
...
switchpage = document.querySelectorAll(".textonsun1");
